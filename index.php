        ...
        <div class=" center">
          ...
          <!--Login Form-->
                ...
                <div class="col-lg-6 col-md-6 ">
                        ...
                        <div class="form-group">
                        <label for="phone">Phone Number (<small>Format: 234-801-1234-567</small>)</label>
                            <span class="adon-icon"><span class="fa fa-phone"></span></span>
                            <input id="phone" placeholder="234-801-1234-567" type="tel" class="form-control" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}-[0-9]{3}" required>
                        </div>
