...
// Define the query:
$q = "SELECT state_name, lga_name, ward_name, u.ward_id AS wid, u.state_id AS stid, u.lga_id AS lid, count(u.first_name) AS user_count 
FROM ward AS wa 
...
while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
    ...
    <td align="left"><a href="show_user_by_ward.php?wid=' . str_replace(' ', '', $row['wid']) . '&stid=' . $row['stid'] . '&lid=' . $row['lid'] . '"><span class="btn btn-danger"><i class="fas fa-eye"></i> View Members</span></a></td>
