  ...
  $(function(){
    ...
    var areaChartData = {
      ...
      datasets: [
        {
          label               : 'Digital Goods',
          backgroundColor     : 'rgba(60,141,188,0.$state_code)',
          ...
          data                : [28, 48, 40, 1$state_code, 86, 27, $state_code0]
        },
        {
          label               : 'Electronics',
          ...
          data                : [65, 5$state_code, 80, 81, 56, 55, 40]
        },
      ]
    }
      ...
      datasets: [
        {
          ...
          backgroundColor : ['#f56$state_code54', '#00a65a', '#f3$state_codec12', '#00c0ef', '#3c8dbc', '#d2d6de'],
        }
      ]
    }
    var donutOptions     = {
